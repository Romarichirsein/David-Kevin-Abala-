...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        fr: {
            ...
            "tab2.desc2": "Modérateur et Maître de Célémonie sur des forums stratégiques sur les relations internationales (Europe de l'Est / Afrique, sommets économiques et mariages VIP).",
            ...
            "pcard5.role": "Rôle : Maître de Célémonie Principal",
            ...
            "portfolio.title": "Portfolio des Projets & Émissions",
            "portfolio.desc": "Découvrez une sélection de réalisations télévisées, d'interviews de haut niveau et d'animations d'événements majeurs.",
            ...
            "form.project": "Domaine de collaboration *",
            "form.selectOpt": "Sélectionnez une option...",
            "opt.mc": "Animation Maître de Célémonie (Mariage/Gala)",
        ...
        en: {
            ...
            "portfolio.tag": "Realizations & On-Air",
            "portfolio.title": "Portfolio of Projects & Shows",
            "portfolio.desc": "Discover a selection of TV productions, high-level interviews, and major event hosting.",
            ...
            "form.heading": "Send a Request",
            "form.name": "Full Name *",
            "form.email": "Email Address *",
            "form.phone": "Phone / WhatsApp *",
            "form.project": "Field of Collaboration *",
            "form.selectOpt": "Select an Option...",
            "opt.mc": "Master of Ceremonies Hosting (Wedding/Gala)",
            "opt.tv": "Radio / TV / Studio Anchoring",
            "opt.media": "Media Strategy & Executive Training",
            "opt.event": "Event Communication Strategy",
            "opt.brand": "Brand Reputation Consulting",
            "form.msg": "Message *",
            "form.submit": "Send via Direct WhatsApp (+237 696 088 243)"
}
    };
    ...
    // ==========================================
    // 10. 3D MOUSE PHYSICS TILT EFFECT (DESKTOP ONLY)
    // ==========================================
